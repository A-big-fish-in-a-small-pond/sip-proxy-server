...
exports.callLegService = void 0;
const string_1 = require("../utils/string");
function callLegService(sip, session) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = (0, string_1.responser)([method, via, from, to, call_id, cseq, context_length]);
        yield session.write(response);
    });
}
exports.callLegService = callLegService;

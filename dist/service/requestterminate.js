...
exports.requestTerminateService = void 0;
const string_1 = require("../utils/string");
function requestTerminateService(sip, session) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = (0, string_1.responser)([method, via, from, to, call_id, cseq, k, server, allow, context_length]);
        yield session.write(response);
    });
}
exports.requestTerminateService = requestTerminateService;
